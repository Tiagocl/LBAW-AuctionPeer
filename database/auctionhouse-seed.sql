...
INSERT INTO auction (title, description, start_date, end_date, status, minimum_bid, current_bid, category_id, creator_id, created_at) VALUES ('Test Auction', 'Used laptop, good condition', NOW() - INTERVAL '30 days', NOW() + INTERVAL '2 minutes', 'active', 100, 100, 1, 1,  NOW() - INTERVAL '30 days');
